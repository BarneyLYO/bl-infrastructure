...
import static cn.blinfra.boot.starter.mybatis.SqlConstants.DB_TYPE;
import static com.alibaba.druid.util.JdbcConstants.ORACLE;
import static com.alibaba.druid.util.JdbcConstants.SQL_SERVER;
import static com.baomidou.mybatisplus.annotation.DbType.ORACLE_12C;
import static com.baomidou.mybatisplus.annotation.DbType.SQL_SERVER2005;
...
public class QueryWrapperX<T> extends QueryWrapper<T> {
  ...
  public QueryWrapperX<T> limitN(int n) {
    Assert.notNull(DB_TYPE, "获取不到数据库的类型");
    if (Objects.equals(DB_TYPE, ORACLE) || Objects.equals(DB_TYPE, ORACLE_12C)) {
      super.eq("ROWNUM", n);
    }
    else if (Objects.equals(DB_TYPE, SQL_SERVER) ||
             Objects.equals(DB_TYPE, SQL_SERVER2005)) {
      super.select("TOP " +
                   n +
                   " *");
