...
import cn.blinfra.boot.starter.apilog.service.ApiErrorLog;
...
import static cn.blinfra.boot.common.constants.GlobalErrorCodeConstants.*;
...
public class GlobalExceptionHandler {
   ...
   * @return 通用返回
   */
  public CommonResult<?> allExceptionHandler(
  ...
  public CommonResult<?> constraintViolationExceptionHandler(
  ...
  public CommonResult<?> noHandlerFoundExceptionHandler(
  ...
  public CommonResult<?> requestNotPermittedExceptionHandler(
    HttpServletRequest req,
    RequestNotPermitted ex
  ) {
    log.warn(
      "[requestNotPermittedExceptionHandler][url({}) 访问过于频繁]",
      req.getRequestURL(),
      ex
    );
  ...
  public CommonResult<?> accessDeniedExceptionHandler(
    HttpServletRequest req,
  ...
  private void createExceptionLog(HttpServletRequest req, Throwable e) {
    ...
    try {
      ...
      log.error(
        ...
        req.getRequestURI(),
        JsonUtils.toJsonString(errorLog),
        th
      );
    }
  }
